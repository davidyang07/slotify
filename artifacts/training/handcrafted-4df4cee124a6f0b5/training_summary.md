# Training run `handcrafted-4df4cee124a6f0b5`
...
- **Generated**: 2026-07-22T23:43:23+00:00
...
| Best epoch | 1 |
| Epochs run | 9 |
| Validation NDCG@3 | 0.9374 |
| Validation pairwise accuracy | 0.9302 |
| Validation classification F1 | 0.9286 |
| Runtime (s) | 3.4230 |
| Device | `cpu` (float32) |
| Stop reason | validation metric did not improve by more than 0.0001 for 8 epoch(s); best was 0.9374295031969658 at epoch 1 |
